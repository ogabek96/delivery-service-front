                ...
                <li>
                  <div class="dropdown-messages-box">
                    ...
                    <div class="message-body">
                      ...
                      <a href="#"
                        >New message from <strong>Jane Doe</strong>.</a
                      >
                      <br /><small class="text-muted"
                        >12:27 pm - 25/03/2015</small
                      >
                    </div>
                  </div>
                </li>
      ...
      <ul class="nav menu">
        <li class="parent ">
          <a data-toggle="collapse" href="#sub-item-1">
            <em class="fa fa-navicon">&nbsp;</em> Orders
            <span
              data-toggle="collapse"
              href="#sub-item-1"
          ...
          <ul class="children collapse" id="sub-item-1">
            ...
            <li>
              <router-link to="/orders/create">
                <span class="fa fa-arrow-right">&nbsp;</span> Create a new order
              </router-link>
            </li>
          </ul>
        </li>
        <li>
          <router-link to="/login"
            ><em class="fa fa-power-off">&nbsp;</em> Logout</router-link
          >
        </li>
      </ul>
    </div>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-12">
                    Order location: {{ orderData.location }}
                  </div>
                  <div class="col-12">Order Price: {{ orderData.price }}</div>
                  <div class="col-12">
...
<script>
import {
  getProcessing as getProcessingOrder,
  closeProcessing as closeProcessingOrder
} from "@/api/order";
export default {
  data() {
    return {
  ...
  created() {
    return getProcessingOrder().then(order => {
      if (order.data.info === "empty") {
        this.$router.push({ name: "AvailableOrders" });
      }
  ...
  methods: {
    close() {
      return closeProcessingOrder().then(() => {
        this.$notify({
          title: "Success",
