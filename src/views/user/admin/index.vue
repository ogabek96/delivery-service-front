		...
		<ul class="nav menu">
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					<li> <router-link to="/orders"> <span class="fa fa-arrow-right">&nbsp;</span> View Orders </router-link> </li>
					<li> <router-link to="/orders/create"> <span class="fa fa-arrow-right">&nbsp;</span> Create a new order </router-link> </li>
				</ul>
			</li>
			<li><router-link to="/login"><em class="fa fa-power-off">&nbsp;</em> Logout</router-link></li>
		</ul>
	</div><!--/.sidebar-->
